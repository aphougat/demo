...
public class DemoController {
    ...
    public String bulkcreate(){
        Offer offer = new Offer(
                "ABH1", "ABH1", Offer.OfferType.COMPLEX, 1);

        offerRepository.saveAll(Arrays.asList(new Offer(
                        "ABH2", "ABH1", Offer.OfferType.COMPLEX, 1)
                ,new Offer(
                        "ABH3", "ABH1", Offer.OfferType.COMPLEX, 1)
                , new Offer(
                        "ABH4", "ABH1", Offer.OfferType.COMPLEX, 1)
                , new Offer(
                        "ABH5", "ABH1", Offer.OfferType.COMPLEX, 1)));
